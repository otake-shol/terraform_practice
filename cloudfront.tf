...
resource "aws_cloudfront_distribution" "cf" {
  ...
  origin {
    ...
    custom_origin_config {
      ...
      origin_ssl_protocols   = ["TLSv1", "TLSv2", "TLSv1.2"]
      http_port              = 80
      https_port             = 443
    }
  }
  ...
  origin {
    ...
    s3_origin_config {
      origin_access_identity = aws_cloudfront_origin_access_identity.cf_s3_cloudfront_origin_access_identity.cloudfront_access_identity_path
    }
  }
...
resource "aws_cloudfront_origin_access_identity" "cf_s3_cloudfront_origin_access_identity" {
